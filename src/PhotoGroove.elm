...
import Json.Decode.Pipeline as DecodePl
import Random
...
photoDecoder =
    Decode.succeed buildPhoto
        |> DecodePl.required "url" Decode.string
        |> DecodePl.required "size" Decode.int
        |> DecodePl.optional "title" Decode.string "(untitled)"
